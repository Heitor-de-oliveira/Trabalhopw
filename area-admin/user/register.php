            ...
            <div class="card-body row justify-content-center align-items-center">
              <div class="col-md-2   text-center">
                <div class="bg-white rounded">
                  <img id="preview" src="../../img/user/padrao.png" alt="..." class=" w-75" required>
                </div>
              </div>
              <div class=" col-md-10">
                <div class="row">
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <input type="text" data-mask="000.000.000-00"  data-mask-selectonfocus="true" class="form-control" name="cpf" maxlength="50" id="cpf">
                    <div class="invalid-feedback">
                    CPF Inválido
                  </div>
                  </div>                                                                                                                     
